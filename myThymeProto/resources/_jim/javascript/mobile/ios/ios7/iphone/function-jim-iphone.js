...
(function(window, undefined) {
					...
					default:
						if(key.length===1) {
							...
							if(key==="." || key==="," || key==="?" || key==="!" || key==="'") {
								var topPos = (jQuery(pressedTarget).position().top*zoom)-63;
								...
								var topPos = (jQuery(pressedTarget).position().top*zoom)-64;
								var leftPos = (jQuery(pressedTarget).position().left*zoom)-16;
								if(jimMobile.orientation()==="landscape") {
									topPos-=6;
									if(jQuery("#jim-body.iphone5").length>0) {
										leftPos-=1;
									}
									else {
										leftPos+=1;
	...
	function bindDropDown() {
		jQuery("#jim-iphone-dd").on("mouseup", function(event, data) {
			...
			if(dragStart) {
				dragStart = false;
				var topPos = jQuery("#jim-case").hasClass("portrait") ? 88 : 68,
				comPos = topPos,
				childHeight = parseInt(jQuery(".options").height()) + parseInt(jQuery(".options").css('padding-top')),
				i=0;
				
				if(jQuery("#jim-case").hasClass("portrait") && parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))*zoom>88) 
					topPos = 88;
				else if(jQuery("#jim-case").hasClass("landscape") && parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))*zoom>68)
					topPos = 68;
				else {
					...
					switch(key) {
						...
						case "options":
							...
							if(jQuery("#jim-case").hasClass("portrait")) {
								...
								jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : 68-($target.position().top*zoom) + "px", queue : false });
								jQuery("#jim-iphone-dd_options_big .dd_options").animate({ "top" : 0-($target.position().top*zoom) + "px", queue : false });
							}
							break;
						case "dd_controls-done":
							var currentPos = parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top')),
							topPos = jQuery("#jim-case").hasClass("portrait") ? 88 : 68,
							childHeight = parseInt(jQuery(".options").height()) + parseInt(jQuery(".options").css('padding-top')),
							$target;
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : -(childHeight*(ddSize-4))-1 +"px", queue:false});
						jQuery("#jim-iphone-dd_options_big .dd_options").animate({ "top" : -(childHeight*(ddSize-4))-7-62 +"px", queue:false});
					}
					dragStart=false;
				}
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : 68 + "px", queue:false });
						jQuery("#jim-iphone-dd_options_big .dd_options").animate({ "top" : 0 + "px", queue:false });
					}
					dragStart=false;
				}
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dd_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dd_options_big .dd_options").css("top", parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))-68 +"px");
						else jQuery("#jim-iphone-dd_options .dd_options").css("top", parseInt(jQuery("#jim-iphone-dd_options_big .dd_options").css('top'))+68 +"px");
					}
				}
			}
		...
		switch(type) {
			...
			case itemType.nativedropdown:
				...
				if(jQuery("#jim-case").hasClass("portrait")) {
					...
					jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : -(selectedPos*childHeight) + 68 + "px", queue:false });
					jQuery("#jim-iphone-dd_options_big .dd_options").animate({ "top" : -(selectedPos*childHeight) + "px", queue:false });
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-da_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-da_options_big .da_days").css("top", parseInt(jQuery("#jim-iphone-da_options .da_days").css('top'))-71 +"px");
						else jQuery("#jim-iphone-da_options .da_days").css("top", parseInt(jQuery("#jim-iphone-da_options_big .da_days").css('top'))+71 +"px");
					}
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-da_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-da_options_big .da_months").css("top", parseInt(jQuery("#jim-iphone-da_options .da_months").css('top'))-71 +"px");
						else jQuery("#jim-iphone-da_options .da_months").css("top", parseInt(jQuery("#jim-iphone-da_options_big .da_months").css('top'))+71 +"px");
					}
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-da_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-da_options_big .da_years").css("top", parseInt(jQuery("#jim-iphone-da_options .da_years").css('top'))-71 +"px");
						else jQuery("#jim-iphone-da_options .da_years").css("top", parseInt(jQuery("#jim-iphone-da_options_big .da_years").css('top'))+71 +"px");
					}
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-ti_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-ti_options_big .ti_hours").css("top", parseInt(jQuery("#jim-iphone-ti_options .ti_hours").css('top'))-71 +"px");
						else jQuery("#jim-iphone-ti_options .ti_hours").css("top", parseInt(jQuery("#jim-iphone-ti_options_big .ti_hours").css('top'))+71 +"px");
					}
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-ti_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-ti_options_big .ti_minutes").css("top", parseInt(jQuery("#jim-iphone-ti_options .ti_minutes").css('top'))-71 +"px");
						else jQuery("#jim-iphone-ti_options .ti_minutes").css("top", parseInt(jQuery("#jim-iphone-ti_options_big .ti_minutes").css('top'))+71 +"px");
					}
				}
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-ti_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-ti_options_big .ti_periods").css("top", parseInt(jQuery("#jim-iphone-ti_options .ti_periods").css('top'))-71 +"px");
						else jQuery("#jim-iphone-ti_options .ti_periods").css("top", parseInt(jQuery("#jim-iphone-ti_options_big .ti_periods").css('top'))+71 +"px");
					}
				}
			}
			else event.preventDefault();
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dt_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dt_options_big .dt_date").css("top", parseInt(jQuery("#jim-iphone-dt_options .dt_date").css('top'))-71 +"px");
						else jQuery("#jim-iphone-dt_options .dt_date").css("top", parseInt(jQuery("#jim-iphone-dt_options_big .dt_date").css('top'))+71 +"px");
					}
				}
			}
			else event.preventDefault();
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dt_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dt_options_big .dt_hours").css("top", parseInt(jQuery("#jim-iphone-dt_options .dt_hours").css('top'))-71 +"px");
						else jQuery("#jim-iphone-dt_options .dt_hours").css("top", parseInt(jQuery("#jim-iphone-dt_options_big .dt_hours").css('top'))+71 +"px");
					}
				}
			}
			else event.preventDefault();
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dt_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dt_options_big .dt_minutes").css("top", parseInt(jQuery("#jim-iphone-dt_options .dt_minutes").css('top'))-71 +"px");
						else jQuery("#jim-iphone-dt_options .dt_minutes").css("top", parseInt(jQuery("#jim-iphone-dt_options_big .dt_minutes").css('top'))+71 +"px");
					}
				}
			}
			else event.preventDefault();
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dt_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dt_options_big .dt_periods").css("top", parseInt(jQuery("#jim-iphone-dt_options .dt_periods").css('top'))-71 +"px");
						else jQuery("#jim-iphone-dt_options .dt_periods").css("top", parseInt(jQuery("#jim-iphone-dt_options_big .dt_periods").css('top'))+71 +"px");
					}
				}
			}
			else event.preventDefault();
	...
	jQuery.extend(jimMobile, {
		...
		"resetWidgets": function() {
			...
			if(jQuery("#jim-case").hasClass("portrait")) {
				...
				jQuery("#jim-iphone-dd #jim-iphone-dd_options .dd_options").css("top", 68-(i*childHeight) + "px");
				jQuery("#jim-iphone-dd #jim-iphone-dd_options_big .dd_options").css("top", -(i*childHeight) + "px");
			}
			//date
